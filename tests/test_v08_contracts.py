...
def test_v08_versions_and_navigation_defaults() -> None:
    assert ENGINE_VERSION == "0.8.0"
    assert ARTIFACT_SCHEMA_VERSION == "1.7"
...
def test_literature_report_exposes_v08_artifact_counts() -> None:
    ...
    assert report.engine_version == "0.8.0"
    assert report.artifact_schema_version == "1.7"
