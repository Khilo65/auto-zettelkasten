...
| G-08 | Blind candidate usefulness remained 23/30 after the first correction | Discovery still retained a few pairs that depended on the route goal after reading the endpoint profiles | Add one same-call self-check with the family goal removed; no verifier, filter, or extra stage | Fresh frozen 30-pair audit: at least 24 useful; retain at least 155 endpoints and 219/219 exact routes | Prompt v19 implemented; paid calibration pending |
