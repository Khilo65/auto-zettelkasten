...
| G-13 | Current citation-pair decisions were re-adjudicated and older revisions resurfaced | Mandatory citation candidates were re-added even when a fresh accepted decision already covered the pair | Remove fresh visible pairs from semantic mandatory work; keep deterministic citation links and refresh only stale pairs | Active citation-pair regression; targeted state repair; exact replay | Root fix passed; state repair pending |
